...
// DO NOT EDIT
namespace Pay_Pal_Checkout_Sdk\Orders;

use Pay_Pal_Http\Http_Request;
class Orders_Patch_Request extends Http_Request
{
    public function __construct($order_id)
    {
        parent::__construct('/v2/checkout/orders/{order_id}?', 'PATCH');
        $this->path = str_replace('{order_id}', urlencode((string) $order_id), $this->path);
