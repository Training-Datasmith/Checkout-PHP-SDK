...
class Authorizations_Reauthorize_Request extends Http_Request
{
    ...
    public function pay_pal_request_id($pay_pal_request_id): void
    {
        $this->headers['PayPal-Request-Id'] = $pay_pal_request_id;
    }
